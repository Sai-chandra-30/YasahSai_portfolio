...
const certifications = [
  { name: "Analytics Vidhya — AI/ML Bootcamp", icon: "🤖" },
  { name: "Microsoft Azure Fundamentals", icon: "☁️" },
];
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              {certifications.map((cert) => (
                <div
                  key={cert.name}
                  className="flex items-center gap-2 bg-background border border-border px-4 py-2.5 rounded-lg hover:border-accent/40 transition-colors duration-200"
                >
                  <span>{cert.icon}</span>
