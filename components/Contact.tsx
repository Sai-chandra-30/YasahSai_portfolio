        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            <p className="text-gray-300 text-lg leading-relaxed mb-8">
              Got an idea worth building, a role worth exploring, or just want to connect?
              I&apos;m always open to internships, full-time opportunities, research collabs, and
              conversations that lead somewhere interesting — don&apos;t hesitate to reach out.
            </p>
