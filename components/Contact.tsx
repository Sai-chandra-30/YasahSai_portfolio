...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.location.href = `mailto:yasah.borusu@gmail.com?subject=${subject}&body=${body}`;
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full py-3 bg-accent text-background font-semibold rounded-lg hover:bg-accent-hover transition-colors duration-200"
            >
              Send Message
            </button>
          </motion.form>
